...
white_wine_data = readtable('winequality-white.csv','Delimiter',';');

Alpha = 0.001;

Features_data = table2array(white_wine_data(:, 1:end-1)); % Features
quality_data = round(white_wine_data.quality); %qualities / class labels
